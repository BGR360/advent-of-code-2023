...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `29.8µs` | `339.3µs` |
| [Day 2](./src/bin/02.rs) | `79.5µs` | `82.9µs` |
| [Day 3](./src/bin/03.rs) | `400.8µs` | `396.1µs` |
| [Day 4](./src/bin/04.rs) | `176.3µs` | `175.9µs` |
| [Day 5](./src/bin/05.rs) | `19.4µs` | `52.5µs` |
| [Day 6](./src/bin/06.rs) | `17.0ns` | `60.0ns` |
| [Day 7](./src/bin/07.rs) | `3.1ms` | `102.4ms` |
| [Day 8](./src/bin/08.rs) | `912.2µs` | `-` |
| [Day 9](./src/bin/09.rs) | `243.8µs` | `238.6µs` |
| [Day 10](./src/bin/10.rs) | `1.7ms` | `6.6ms` |
| [Day 11](./src/bin/11.rs) | `1.8ms` | `1.8ms` |
| [Day 12](./src/bin/12.rs) | `1.6ms` | `12.5ms` |
| [Day 13](./src/bin/13.rs) | `483.3µs` | `590.8µs` |
| [Day 14](./src/bin/14.rs) | `129.5µs` | `44.0ms` |
| [Day 15](./src/bin/15.rs) | `58.0µs` | `609.5µs` |
| [Day 16](./src/bin/16.rs) | `734.7µs` | `192.3ms` |
| [Day 17](./src/bin/17.rs) | `25.5ms` | `89.4ms` |
