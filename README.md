...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `30.0µs` | `339.4µs` |
| [Day 2](./src/bin/02.rs) | `69.9µs` | `72.4µs` |
| [Day 3](./src/bin/03.rs) | `402.1µs` | `395.5µs` |
| [Day 4](./src/bin/04.rs) | `175.0µs` | `173.1µs` |
| [Day 5](./src/bin/05.rs) | `18.2µs` | `50.6µs` |
| [Day 6](./src/bin/06.rs) | `18.0ns` | `60.0ns` |
| [Day 7](./src/bin/07.rs) | `3.1ms` | `100.7ms` |
| [Day 8](./src/bin/08.rs) | `913.8µs` | `-` |
| [Day 9](./src/bin/09.rs) | `243.0µs` | `238.5µs` |
| [Day 10](./src/bin/10.rs) | `2.1ms` | `7.2ms` |
