...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `31.5µs` | `338.0µs` |
| [Day 2](./src/bin/02.rs) | `70.1µs` | `73.0µs` |
| [Day 3](./src/bin/03.rs) | `404.9µs` | `396.1µs` |
| [Day 4](./src/bin/04.rs) | `174.1µs` | `172.0µs` |
| [Day 5](./src/bin/05.rs) | `18.2µs` | `51.1µs` |
| [Day 6](./src/bin/06.rs) | `18.0ns` | `60.0ns` |
| [Day 7](./src/bin/07.rs) | `3.1ms` | `102.9ms` |
| [Day 8](./src/bin/08.rs) | `909.8µs` | `-` |
| [Day 9](./src/bin/09.rs) | `242.3µs` | `236.4µs` |
| [Day 10](./src/bin/10.rs) | `2.1ms` | `7.1ms` |
| [Day 11](./src/bin/11.rs) | `2.3ms` | `2.3ms` |
| [Day 12](./src/bin/12.rs) | `244.2ms` | `-` |
| [Day 13](./src/bin/13.rs) | `863.6µs` | `964.3µs` |
| [Day 14](./src/bin/14.rs) | `373.9µs` | `44.5ms` |
